    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="d-flex justify-content-between">
                ...
                <div class="">
                    <a href="<?= BASE_URL_ADMIN . '?act=tai-khoan-khach-hang' ?>" class="btn btn-secondary"><i class="fa fa-backward"></i> Quay Lai</a>
                </div>
            </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-12">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Thêm Tài Khoản Client</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= BASE_URL_ADMIN . '?act=them-tai-khoan-khach-hang' ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" class="form-control" min="0" name="so_dien_thoai" placeholder="Nhập số diện thoại">
