                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= BASE_URL_ADMIN . '?act=form-them-san-pham'  ?>" class="btn btn-success"><i class="fas fa-add"></i> <!-- Icon thêm -->Thêm sản phẩm</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                    ...
                                    <?php foreach ($listProduct as $key => $product): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= BASE_URL_ADMIN . '?act=form-sua-san-pham&id_san_pham=' . $product['id'] ?>"><button class="btn btn-primary"><i class="fas fa-edit"></i> <!-- Icon sửa --></button>
                                                </a>
