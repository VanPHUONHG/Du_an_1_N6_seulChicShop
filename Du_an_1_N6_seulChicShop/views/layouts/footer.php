<!-- Footer -->
<footer class="p-b-32 p-t-75 bg3">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-sm-6 p-b-50">
                <h4 class="p-b-30 cl0 stext-301">
                    Categories
                </h4>
            ...
            <div class="col-lg-3 col-sm-6 p-b-50">
                ...
                <form>
                    <div class="p-b-4 w-full wrap-input1">
                        <input class="input1 bg-none cl7 plh1 stext-107" type="text" name="email"
                            placeholder="email@example.com">
                        <div class="focus-input1 trans-04"></div>
                    </div>

                    <div class="p-t-18">
                        <button class="flex-c-m p-lr-15 bg1 bor1 cl0 hov-btn2 size-103 stext-101 trans-04">
                            Subscribe
                        </button>
                    </div>
                </form>
        ...
        <div class="p-t-40">
            ...
            <p class="cl6 stext-107 txt-center">
...
<!-- Modal1 -->
<div class="p-b-20 p-t-60 js-modal1 wrap-modal1">
    <div class="js-hide-modal1 overlay-modal1"></div>

    <div class="container">
        <div class="p-b-30 p-lr-15-lg p-t-60 bg0 how-pos3-parent">
            <button class="hov3 how-pos3 js-hide-modal1 trans-04">
